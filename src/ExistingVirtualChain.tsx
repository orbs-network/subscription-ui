...
class ExistingVirtualChain extends React.Component<
  ExistingVirtualChainProps,
  ExistingVirtualChainState
> {
        ...
        <div>
          <form noValidate autoComplete="off">
            ...
            <TextField
              ...
              onChange={(event) =>
                this.setState({
                  virtualChainId: this.parseVirtualChainId(event.target.value),
                })
              }
            ></TextField>
            <br />
